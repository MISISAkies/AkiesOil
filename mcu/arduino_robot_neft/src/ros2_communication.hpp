...
int rosTurn(){
  ...
  return turnAngle(angle, speed);
}

int goDist(int dist, int speed){
...
void command_spin(){
  ...
  if (Serial.available() > 1) {
    ...
    case GET_DATA: break; 
    case TURN_ROBOT: turnTicks = rosTurn(); turn_flag=1; break;
    case MOVE_DIST: moveTicks = rosDist(); move_flag=1; break;
